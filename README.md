...
Welcome to my repository where I practice problem-solving skills using Python and Java! This repo contains solutions to various coding challenges, primarily from [Exercism](https://exercism.io/tracks/python). The focus is on improving algorithm design, understanding data structures, and mastering Python, JavaScript, TypeScript and Java programming.
...
## Technologies Used
- **Python** **JavaScript**, **TypeScript** and **Java**: The core languages used for all challenges.
